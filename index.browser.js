...
function getAll() {
  // console.log(countyDataFilePath);
  return new Promise((resolve, reject) => {
    readCountyData()
      .then((data) => {
        resolve(data);
  ...
  },
  {
    ...
    constituencies: [
      ...
      },
      {
        ...
        wards: ["Mbololo", "Kaloleni", "Sagala", "Marungu", "Kaigau", "Ngolia"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    constituencies: [
      ...
      },
      {
        ...
        wards: ["BUKHAYO WEST", "MAYENJE", "MATAYOS SOUTHBUSIBWABO", "BURUMBA"],
      },
      {
  ...
  },
  {
    ...
    constituencies: [
      ...
      },
      {
        ...
        wards: ["Miwani", "Ombeyi", "Masogo/Nyag’oma", "Chemeli/Muhoroni/Koru"],
      },
      {
  ...
  },
  {
    ...
    constituencies: [
      ...
      },
      {
        ...
        wards: ["Kwa Njenga", "Imara Daima", "Kware", "Kwa Reuben", "Pipeline"],
      },
      {
